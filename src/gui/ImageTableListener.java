...
public class ImageTableListener implements
ListSelectionListener {
	private ImageTable table;
	private ImageTableModel model;
	private static int  rStart = 0, rEnd = 0, colIndexStart = 0, colIndexEnd = 0;
