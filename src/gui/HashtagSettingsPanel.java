...
public class HashtagSettingsPanel extends JPanel implements ActionListener,DocumentListener, ListSelectionListener {
	...
	private JScrollPane jlistScroller;
		...
		private void setConstraints() {
			...
			gbcs[0].set(0, 3, 3, 2, 69, 212, 1.0, 1.0,
					new Insets(10, 20, 0, 0), gc);
